...
pub enum CodeToken {
    ...
    #[token("select", priority = 6)]
    #[token("insert", priority = 6)]
    #[token("update", priority = 6)]
    #[token("delete", priority = 6)]
    #[token("create", priority = 6)]
    #[token("alter", priority = 6)]
    #[token("drop", priority = 6)]
    #[token("truncate", priority = 6)]
    #[token("concatenate", priority = 6)]
    #[token("commit", priority = 6)]
    #[token("rollback", priority = 6)]
    #[token("get", priority = 6)]
    #[token("post", priority = 6)]
    #[token("put", priority = 6)]
    #[token("patch", priority = 6)]
    #[token("head", priority = 6)]
    Verb,
