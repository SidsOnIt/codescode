...
pub enum CodeToken {
    ...
    // Updated single-quote branch: disallows <, >, [, and \n inside single-quoted strings
    #[regex(
        r#""(?:[^"\\\n]|\\.)*"|'(?:\\.|[^'\\\n<>\[])+'|`(?:[^`\\]|\\.)*`|''[\s\S]*?''"#,
        priority = 5
    )]
    ...
    #[token("defstruct")]
    #[token("dataclass")]
    #[regex("[A-Z][a-zA-Z0-9_]*", priority = 1)]
    ...
    #[token("select", priority = 3)]
    #[token("SELECT", priority = 3)]
    #[token("insert", priority = 3)]
    #[token("INSERT", priority = 3)]
    #[token("update", priority = 3)]
    #[token("UPDATE", priority = 3)]
    #[token("delete", priority = 3)]
    #[token("DELETE", priority = 3)]
    #[token("create", priority = 3)]
    #[token("CREATE", priority = 3)]
    #[token("alter", priority = 3)]
    #[token("ALTER", priority = 3)]
    #[token("drop", priority = 3)]
    #[token("DROP", priority = 3)]
    #[token("truncate", priority = 3)]
    #[token("TRUNCATE", priority = 3)]
    #[token("concatenate", priority = 3)]
    #[token("CONCATENATE", priority = 3)]
    #[token("commit", priority = 3)]
    #[token("COMMIT", priority = 3)]
    #[token("rollback", priority = 3)]
    #[token("ROLLBACK", priority = 3)]
    #[token("get", priority = 3)]
    #[token("GET", priority = 3)]
    #[token("post", priority = 3)]
    #[token("POST", priority = 3)]
    #[token("put", priority = 3)]
    #[token("PUT", priority = 3)]
    #[token("patch", priority = 3)]
    #[token("PATCH", priority = 3)]
    #[token("head", priority = 3)]
    #[token("HEAD", priority = 3)]
    Verb,
